...
@section('content')
    <div class="modal fade" id="laporan-pemeriksaan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ibu_hamil.pemeriksaan.laporan') }}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="laporan-kehadiran" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ibu_hamil.pemeriksaan.kehadiran.laporan') }}" method="post">
                    @csrf
                    <div class="modal-header">
    ...
    <div class="col-sm-8" style="float:none;margin:auto;">
        <form action="{{ route('ibu_hamil.pemeriksaan.cari') }}" method="get">
            @csrf
            <div class="card">
                            ...
                            @foreach ($data as $li)
                                @if(\App\Models\Pemeriksaan::firstWhere([['peserta_id','=',$li->peserta->id],['tanggal','=',$tanggal]]))
                                    <tr>
                                        ...
                                        <td>Hadir</td>
                                        <td>
                                            <a href="{{ route('ibu_hamil.pemeriksaan.edit', [$li->peserta->id, $tanggal]) }}"
                                ...
                                @else
                                    <tr class="table-danger">
                                        ...
                                        <td>Tidak Hadir</td>
                                        <td>
                                            <a href="{{ route('ibu_hamil.pemeriksaan.input', [$li->peserta->id, $tanggal]) }}"
