            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Pendaftaran Peserta Baru Balita</h4>
                    </div>
                </div>
                <div class="card-body">
                    @if (session('success'))
                    ...
                    <div class="new-user-info">
                        <form action="{{ route('balita.pendaftaran.post') }}" method="post">
                            @csrf
                            <div class="row mb-4">
                                ...
                                <x-input-text name="ayah" classes="" value=""
                                              type="" form="" label="Nama Ayah"/>
                                <x-input-text name="ibu" classes="" value=""
