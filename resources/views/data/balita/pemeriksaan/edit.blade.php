            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="new-user-info">
                        <form action="{{ route('balita.pemeriksaan.update', [$data->periksa_balita->id, $tanggal]) }}"
                              method="post">
                            @csrf
                            <div class="row mb-4">
